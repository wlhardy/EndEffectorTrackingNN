...
def train(config=None):
    with wandb.init(config=config):
        ...
        for epoch in range(config.epochs):
            ...
            # Create DataLoader
            #dataloader_train = DataLoader(dataset_train, batch_size=batch_size, num_workers=cpu_count, sampler=sampler)
            dataloader_train = DataLoader(dataset_train, batch_size=batch_size, num_workers=cpu_count, shuffle=True)
